...
const Banner = () => {
  ...
  const getCurrentPage = () => setPage(sliderRef.current.innerSlider.state.currentSlide);
...
// 1.처음과 재렌더링 될때마다 렌더링 useEffect(() => {});

// 2.처음에만 렌더링  useEffect(() => {}, []);
// 3.의존성 배열에 들어있는 값이 변경될 때 렌더링  useEffect(() => {}, [count]);
// 4.return () => {} 가 있으면 __ 가 파괴되면 렌더링  
//useEffect(() => {
//   return () => {};
// }, [count]);