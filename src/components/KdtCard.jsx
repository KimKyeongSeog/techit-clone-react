    ...
    return (
      <div className=" w-[290px] h-[416px]">
        <div className="overflow-hidden rounded-lg">
          <img className="hover:scale-110 duration-300 rounded-lg" src={`./images/${image}.webp`} alt={`${image}`} />
        </div>
        <div className="pt-4">
        <span className={`text-sm font-semibold border py-1 px-2 rounded-[4px] 
